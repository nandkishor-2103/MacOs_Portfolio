...
const Trash = () => {
    ...
    return (
        ...
        <div
            className="flex flex-col h-127.5 w-192.5 max-w-5xl bg-white rounded-xl overflow-hidden shadow-2xl border border-gray-200">

            {/* Header: Centered title without overlapping traffic lights */}
            <div id='window-header'
                 className="flex items-center justify-between px-6 py-4 bg-gray-50 border-b border-gray-200 shrink-0">
